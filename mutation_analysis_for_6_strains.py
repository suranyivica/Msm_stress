...
with open(args[1], "r") as f:
    ...
    for i in f1:
        ...
        if columns[2] == "T" and columns[3] == "C" or columns[2] =="A" and columns[3] == "G":
            if float(columns[5]) >= 0.06 and float(columns[5]) < 0.25:
                adduktum = 1
            elif float(columns[5]) >= 0.25 and float(columns[5]) < 0.417:
                adduktum = 2
            elif float(columns[5]) >= 0.417 and float(columns[5]) < 0.583:
                adduktum = 3
            elif float(columns[5]) >= 0.583 and float(columns[5]) < 0.75:
                adduktum = 4
            elif float(columns[5]) >= 0.75 and float(columns[5]) < 0.91667:
                adduktum = 5
            elif float(columns[5]) >= 0.91667:
                adduktum = 6
            else:
